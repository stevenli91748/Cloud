...
[AWS官方操作教程集---重要](https://aws.amazon.com/cn/getting-started/hands-on/)|[AWS官方实验教程](https://www.wellarchitectedlabs.com/security/)|[AWS 架构师学路径](https://aws.amazon.com/cn/training/path-architecting/)|[AWS 架构师培训视频](https://www.aws.training/LearningLibrary?filters=classification%3A2&filters=classification%3A6&filters=classification%3A75&tab=view_all)|
---|---|---|---|
